...
Manoram Production — Productions • Media • Collaborations

Manoram Production collaborates with artists and organisations to create theatre and media projects that explore cultural and social themes. Notable works referenced in the site include:
...
This repository contains the source code for a portfolio site. Content (text and images) belongs to Manoram Production (as provided). The codebase uses open-source libraries; check `package.json` for dependency licenses.
