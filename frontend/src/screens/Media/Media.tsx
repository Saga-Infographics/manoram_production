  ...
  export const Media = (): JSX.Element => {
    return (
      <div className="bg-white w-full relative">
        <SEO title="Media" description="Media gallery — posters, photos and video links for Manoram Production projects." path="/media" />
        ...
        <section className="relative w-full py-12 md:py-24 bg-white">
          <div className="container mx-auto px-6 md:px-40">
            <h1 className="[font-family:'Playfair_Display',Helvetica] font-bold text-[#18386e] text-5xl tracking-[0] leading-[60px] mb-6">
              ...
              Explore video content and photography from Manoram Production's projects. From trailers to behind-the-scenes footage, get an inside look at the creative process.
            </p>
